...
<head>
   ...
   <link href="http://localhost/Class_ex/interface/template/assets/bootstrap/css/bootstrap.min.css" rel="stylesheet" />
   <link href="http://localhost/Class_ex/interface/template/assets/bootstrap/css/bootstrap-responsive.min.css" rel="stylesheet" />
   <link href="http://localhost/Class_ex/interface/template/assets/bootstrap/css/bootstrap-fileupload.css" rel="stylesheet" />
   <link href="http://localhost/Class_ex/interface/template/assets/font-awesome/css/font-awesome.css" rel="stylesheet" />
   <link href="http://localhost/Class_ex/interface/template/css/style.css" rel="stylesheet" />
   <link href="http://localhost/Class_ex/interface/template/css/style_responsive.css" rel="stylesheet" />
   <link href="http://localhost/Class_ex/interface/template/css/style_default.css" rel="stylesheet" id="style_color" />

   <link href="http://localhost/Class_ex/interface/template/assets/fancybox/source/jquery.fancybox.css" rel="stylesheet" />
   <link rel="stylesheet" type="text/css" href="http://localhost/Class_ex/interface/template/assets/uniform/css/uniform.default.css" />
</head>
<!-- END HEAD -->
<!-- BEGIN BODY -->
